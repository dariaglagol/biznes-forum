...
function sendFirstStep($mail){
	$subject = "Регистрация на событие «V РЕГИОНАЛЬНЫЙ ФОРУМ МОЛОДЫХ ПРЕДПРИНИМАТЕЛЕЙ»";
	...
	$body .= '<p>Вступайте в группы и следите за нашими новостями: <a href="https://vk.com/mestorogdenie">vk.com</a> | <a href="https://www.instagram.com/bb_battl/">instagram.com/tmu_lidertomsk/</a></p>';
	$body .= '<hr>';
